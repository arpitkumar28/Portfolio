...
const featuredProjects = [
  ...
  },
  {
    id: 17,
    title: 'Axiora',
    subtitle: 'Modern Software Platform',
    category: 'Project / Source Verification Pending',
    problem: 'Project details are not available in the current portfolio repository.',
    solution: 'This project will be documented after its source code, README, implementation details, and verified links are supplied.',
    result: 'No product claims, users, features, technologies, or metrics are presented until they can be verified.',
    features: ['Source verification pending', 'Implementation details pending', 'Verified links pending'],
    techStack: ['Technology stack pending verification'],
    links: [{ label: 'View Case Study', url: '/axiora', icon: ArrowRight }],
    featured: true,
    gradient: 'from-slate-600 to-slate-900',
    status: 'Details Pending',
    role: 'To be verified',
    timeline: 'To be verified',
  },
  {
    id: 1,
    title: 'GreenFlow AI',
