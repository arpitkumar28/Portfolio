      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-5 inline-flex items-center gap-3 font-mono text-sm font-black uppercase tracking-[0.16em] text-text-muted transition-colors hover:text-primary"
          >
